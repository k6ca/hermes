    ...
    <? include "engine/html/topo-site.php";?>
		<div class="listagem">
			<div class="head-lista">
				<!-- esse filtro é pelo tipo de imovel blza? -->
				<h2 class="h2-lista">Imóveis para locação</h2>
      ...
      $sql_imovel = "SELECT * FROM imoveis WHERE ativo = 'S' AND finalidade = 1 $sql_aux ORDER BY titulo ASC";
